...
async function deployToChain(chainKey: string) {
  ...
  try {
    ...
    deployments.points = pointsAddress;
    ...
    deployments.pointsEscrow = pointsEscrowAddress;
...
# Smart Contracts
VITE_${envPrefix}_POINTS_CONTRACT_ADDRESS=${pointsAddress}
VITE_${envPrefix}_CHALLENGE_FACTORY_ADDRESS=${factoryAddress}
VITE_${envPrefix}_CHALLENGE_ESCROW_ADDRESS=${escrowAddress}
VITE_${envPrefix}_POINTS_ESCROW_ADDRESS=${pointsEscrowAddress}
